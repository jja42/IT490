...
public class Database_Manager : MonoBehaviour
{
    ...
    public void GenerateDatabase()
    {
        Database = new List<Card_Manager.Card>
        {
            ...
            new Card_Manager.Card(1003,"test",Card_Manager.CardType.Fortification,Card_Manager.Type.Galleon,80,"test_ability","test description for ability","Move 1","move 1 description",40,"1100","move 2","move 2 description",20,"3000","5000","flavor text LMAO"),
            new Card_Manager.Card(1004,"test",Card_Manager.CardType.Fortification,Card_Manager.Type.Galleon,80,"test_ability","test description for ability","Move 1","move 1 description",40,"1100","move 2","move 2 description",20,"3000","5000","flavor text LMAO"),
            new Card_Manager.Card(1005,"test",Card_Manager.CardType.Fortification,Card_Manager.Type.Galleon,80,"test_ability","test description for ability","Move 1","move 1 description",40,"1100","move 2","move 2 description",20,"3000","5000","flavor text LMAO"),
            new Card_Manager.Card(1006,"test",Card_Manager.CardType.Fortification,Card_Manager.Type.Galleon,80,"test_ability","test description for ability","Move 1","move 1 description",40,"1100","move 2","move 2 description",20,"3000","5000","flavor text LMAO"),
            new Card_Manager.Card(1007,"test",Card_Manager.CardType.Fortification,Card_Manager.Type.Galleon,80,"test_ability","test description for ability","Move 1","move 1 description",40,"1100","move 2","move 2 description",20,"3000","5000","flavor text LMAO"),
            new Card_Manager.Card(1008,"test",Card_Manager.CardType.Fortification,Card_Manager.Type.Galleon,80,"test_ability","test description for ability","Move 1","move 1 description",40,"1100","move 2","move 2 description",20,"3000","5000","flavor text LMAO"),
